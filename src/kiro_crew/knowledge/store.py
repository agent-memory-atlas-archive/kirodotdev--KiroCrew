...
# the cleanup at #7019.
#
# ``dashboard/handlers/knowledge.py`` reaches the store through a worker
# everywhere, endpoints and background tasks alike. Two takes are left. The
# watcher's self-heal rebuild finalizes its job row inline on its cancellation
# path (the two lines the baseline still lists), where an interrupted
