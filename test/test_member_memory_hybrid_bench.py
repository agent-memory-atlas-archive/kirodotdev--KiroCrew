...
def test_committed_hybrid_report_preserves_its_measured_corpus_and_policy():
    path = Path(member_v2.__file__).parent / "data" / "member-v2-hybrid-qwen3-current.json"
    ...
    assert report["benchmark_snapshot"] == "snapshot_after_retention_change"
