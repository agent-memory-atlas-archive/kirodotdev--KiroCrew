...
export type MemberMemoryState = 'legacy' | 'private' | 'unavailable'
...
export function MemoryStoreField({ value = '', member, memoryState = 'unavailable', onInitialize, onManage, busy = false, manageDisabled = false }: {
  value?: string; member?: string; memoryState?: MemberMemoryState
  onInitialize?: () => void; onManage?: () => void; busy?: boolean; manageDisabled?: boolean
    ...
    : isGlobal
      ...
      : memoryState === 'private'
        ...
        : memoryState === 'legacy'
          ...
          : i18nT('pages.kiroCrewAgentsPage.memory_binding_unavailable')
  return (
    <Field label={i18nT('pages.kiroCrewAgentsPage.memory_store')} hint={hint}>
      ...
      <div className="flex flex-wrap gap-2">
        {member && !isGlobal && memoryState === 'legacy' && onInitialize && (
          <Btn onClick={onInitialize} disabled={busy}>{i18nT('pages.kiroCrewAgentsPage.initialize_private_memory')}</Btn>
        )}
        {(isGlobal || memoryState === 'private') && onManage && (
          <Btn onClick={onManage} disabled={busy || manageDisabled} title={manageDisabled ? i18nT('components.crewEditor.unsaved_changes') : undefined}>
                ...
                >
                  ...
                  {pane === 'place' && (
                    <>
                      ...
                      />
                      {/* Other members require private V2 before work; a legacy
                          shared binding does not grant shared memory access. */}
