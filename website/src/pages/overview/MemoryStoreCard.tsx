    ...
    <Card className={compact ? '!px-3 !py-2' : undefined}>
      ...
      <div className="flex gap-2 items-center flex-wrap">
        <SimpleSelect
          ...
          optionLabels={rows.map(s => s.is_default ? i18nT('pages.kiroCrewAgentsPage.global_memory_v1') : s.owner_member ? i18nT('memoryV2.member_store_label', { member: s.owner_member, version: PRIVATE_MEMORY_VERSION }) : s.name)}
