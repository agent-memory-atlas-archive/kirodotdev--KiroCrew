...
export const api = {
  ...
  correctMemberEpisode: (body: { store: string; id: string; text: string }) =>
    patch('/api/memory/episodic', body).then(j) as Promise<{ ok: boolean; store: string; id: string; changed: boolean }>,
