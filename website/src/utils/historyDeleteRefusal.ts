 ...
 * the by-id release, a busy cron store wants a retry, an unreadable one wants
 * the file repaired. A rejection carrying no recognised code (a dropped
 * connection, a 5xx) gets the generic sentence.
 */
import { i18nT } from '../i18n/t'

/** A refused delete, as the store records it: raw facts, localized at render. */
export type HistoryDeleteRefusal = { key: string; title: string; code: string }
