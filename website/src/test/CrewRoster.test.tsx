...
describe('crew roster — memory ownership notice', () => {
  ...
  it('keeps workspace guidance and states the optional V1 to private V2 transition explicitly', async () => {
    await renderRoster()
    ...
    const memory = within(sheet).getByText(/Memory V1\. This member can keep working/)
    expect(memory).toHaveTextContent('A new private Memory V2 starts empty')
    expect(memory).toHaveTextContent('Memory V1 stays unchanged')
  })
