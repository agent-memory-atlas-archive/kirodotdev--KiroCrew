...
describe('source tab project disambiguation', () => {
  ...
  it('qualifies with the host when the same project path exists on two hosts', async () => {
    ...
    expect(await screen.findByRole('tab', { name: /gitlab\.com\/group-a\/service MR !1/i })).toBeInTheDocument()
    expect(screen.getByRole('tab', { name: /gitlab\.internal\/group-a\/service MR !1/i })).toBeInTheDocument()
  })
