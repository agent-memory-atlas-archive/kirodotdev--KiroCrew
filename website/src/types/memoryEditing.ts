...
export type MemoryRecord = {
  ...
  revision: string
  metadata?: { revision?: number; category?: string; subject?: string; predicate?: string; status?: string; source_ref?: string; email_addresses?: string[]; has_email?: boolean; pending_conflicts?: number }
}
